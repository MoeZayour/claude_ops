...
class TestBiSqlViewEditor(SingleTransactionCase):
    ...
    def test_process_view(self):
        ...
        field_lines.filtered(lambda x: x.name == "x_name").list_visibility = "invisible"
        field_lines.filtered(
            lambda x: x.name == "x_slistt"
        ).list_visibility = "optional_hide"
        field_lines.filtered(
            lambda x: x.name == "x_company_id"
        ).list_visibility = "optional_show"
