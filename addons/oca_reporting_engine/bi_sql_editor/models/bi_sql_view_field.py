...
class BiSQLViewField(models.Model):
    ...
    list_visibility = fields.Selection(
    ...
    def _prepare_list_field(self):
        self.ensure_one()
        if self.list_visibility == "unavailable":
            return ""
        visibility_text = ""
        if self.list_visibility == "invisible":
            visibility_text = 'column_invisible="1"'
        elif self.list_visibility == "optional_hide":
            visibility_text = 'optional="hide"'
        elif self.list_visibility == "optional_show":
