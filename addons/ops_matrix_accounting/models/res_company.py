...
class ResCompany(models.Model):
    ...
    # Report color fields moved to ops_theme/models/res_company_branding.py
    # (ops_report_primary_color, ops_report_text_on_primary, ops_report_body_text_color)
    # Helper methods moved: get_report_primary_light(), get_report_primary_dark()
